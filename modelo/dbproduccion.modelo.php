...
class mdlPersonal{
    ...
    static public function mdlMostrarListadoProduccion(){
        ...
        $consulta = "SELECT * FROM SAS_LISTADO_PERSONAL_PRO WHERE IDPLANILLA = 'OBR'
        AND numero = 1 ORDER BY  APENOM";
        $resultado=Conexion::conectar()->query($consulta);
        //lleno el array con cada dato del resultado
        
            return $resultado;
    }
    static public function mdlMostrarListado2017(){
        ...
        //$consulta = "SELECT IDCODIGOGENERAL, IDCARGO FROM PERSONAL";
        $consulta = "SELECT * FROM SAS_LISTADO_PERSONAL_2017 WHERE IDPLANILLA = 'OBR'
        AND numero = 1 ORDER BY  APENOM";
        $resultado=Conexion::conectar()->query($consulta);
        //lleno el array con cada dato del resultado
