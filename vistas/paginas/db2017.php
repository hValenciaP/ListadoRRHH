                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped dt-responsive tablaUsuarios" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <?php  ?>
                                    <?php
                                    $respuesta = ctrPersonal::ctrMostrarListado2017();
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Confirmar el registro del Personal <?php echo $value["APENOM"] . " con Nro de Documento ". $value["NRODOCUMENTO"] ." a la base SATURNO 2017 "; ?>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                                                        <button onclick="agregar(this.datos)" type="button" class="btn btn-success">Confirmar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
